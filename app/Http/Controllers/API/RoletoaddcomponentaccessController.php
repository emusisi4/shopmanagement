...
class RoletoaddcomponentaccessController extends Controller
{
    /**
...
$userrole =  auth('api')->user()->type;
   ...
   //  $hid = $id1+1;
   DB::table('roletoaddcomponents')->where('ucret', $userid)->delete();
 // $datepaid = date('Y-m-d');
     
  //       $dats = $id;
       return Roletoaddcomponent::Create([
      'rolename' => $request['roleyouareaddingtocomponent'],
