      ...
      <div class="card" v-if="allowedtoaccesscomponent > 0 ">
              <div class="card-header">
                ...
                <div class="card-tools" v-if="info > 0">
                    ...
                    <button type="button" class="btn btn-success btn-xs" @click="newModal" >Add Expense </button>
  ...
  confirmButtonText: 'Yes, delete it!'
    ...
    if(result.value){
           ...
           checkAccess(){
            ...
            loadDatarecords(){
                      axios.get("api/shopmakeexpensescomponentaccess").then(({ data }) => (this.allowedtoaccesscomponent = data));
                                 axios.get("api/makeexpense").then(({ data }) => (this.mydataObject = data));
