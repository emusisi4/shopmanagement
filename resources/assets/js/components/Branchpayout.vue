...
<div>
     <div class="card"  v-if="allowedtoaccesscomponent > 0 ">
              ...
              <div class="card-header">
                <h3 class="card-title"><b>Payouts</b></h3>

                <div class="card-tools">
                   
                    
                    <button type="button" class="btn btn-danger btn-xs" @click="newModal" >Add More Payout </button>
...
$('#addNew').modal('show');
  ...
  confirmButtonText: 'Yes, delete it!'
    ...
    if(result.value){
            ...
            loadDatarecords(){
               axios.get("api/shoppayoutcomponentaccess").then(({ data }) => (this.allowedtoaccesscomponent = data));
