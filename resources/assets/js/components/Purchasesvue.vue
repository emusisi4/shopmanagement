...
<div class="bethapa-component-header" >Purchases </div>
              ...
              <div class="card-header p-0 pt-1 border-bottom-0">
                <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                  ...
                  <a class="nav-link active" id="custom-tabs-three-home-tab" data-toggle="pill" href="#custom-tabs-three-home" role="tab"  @click="loadDatarecords()"
                   aria-controls="custom-tabs-three-home" aria-selected="true">Purchase Records</a>
                  </li>
                  <li class="nav-item" v-if="allowedtoaccesscategoriescomponent > 0 ">
                    <a class="nav-link" id="custom-tabs-three-profile-tab" data-toggle="pill" href="#custom-tabs-three-profile" role="tab" @click="loadDatarecordsCategories()" aria-controls="custom-tabs-three-profile" aria-selected="false">Category</a>
                  </li> 
            
                  <li class="nav-item" v-if="allowedtoaccessproductunitscomponent > 0 ">
       <a class="nav-link" id="custom-tabs-three-messages-tab" data-toggle="pill" href="#custom-tabs-three-messages" role="tab"  @click="loadDatarecordsProductunits()" aria-controls="custom-tabs-three-messages" aria-selected="false">Units Of Measure</a>
                  </li>
                  <li class="nav-item" v-if="allowedtoaccessbrandscomponent > 0 ">
                    <a class="nav-link" id="custom-tabs-three-settings-tab" data-toggle="pill" href="#custom-tabs-three-settings" role="tab" @click="loadDatarecordsProductbrands()" aria-controls="custom-tabs-three-settings" aria-selected="false">Brand</a>
                  </li>
                </ul>
              </div>
              <div class="card-body">
              ...
              <table class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <td>   <template v-if="mydataObjectinfo.product_category">	{{mydataObjectinfo.product_category.catname}}</template></td>
                 ...
                 <tfoot>
                  ...
                  <div class="tab-pane fade" id="custom-tabs-three-profile" role="tabpanel" aria-labelledby="custom-tabs-three-profile-tab">
                    <div class="bethapa-table-header">
                   Category Details <button v-if="infoaddnewcategory > 0" type="button" class="add-newm" @click="newModalcategory" >Add New Category </button>
                      </div>
              <table class="table table-bordered table-striped">
                  <thead>
                    <tr>
                  ...
                  <tbody>
                    ...
                    <td>{{mydataObjectprodcat.id}}</td>
                     ...
                     <td> {{ (mydataObjectprodcat.catname)}}</td>
                ...
                <div class="bethapa-table-header">
                   ...
                   UNIT OF MEASUREMENTS DETAILS <button v-if="infoaddnewunitmeasure > 0" type="button" class="add-newm" @click="newModalUnitmeasure" >Add New </button>
                      </div>
              <table class="table table-bordered table-striped">
                  <thead>
                    <tr>
                  ...
                  <tbody>
                    ...
                    <td>{{mydataObjectunit.id}}</td>
                     ...
                     <td> {{ (mydataObjectunit.unitname)}}</td>
                   ...
                   <td> {{ (mydataObjectunit.shotcode)}}</td>
                     ...
                     <button type="button"  v-if="infoeditunitmeasure > 0"   class="btn  bg-gradient-secondary btn-xs fas fa-edit"   @click="editModalUnitmeasure(mydataObjectunit)">   </button>
                      <button type="button"  v-if="infodeleteunitmeasure > 0" class="btn  bg-gradient-danger btn-xs fas fa-trash-alt"  @click="deleteUnitmeasure(mydataObjectunit.id)">  </button>
                 <button type="button" v-if="infoviewrecordunitmeasure > 0"   class="btn  bg-gradient-info btn-xs fas fa-eye"   @click="editModalUnitmeasure(mydataObjectunit)">   </button>
                      </td>
                    </tr>
                 ...
                 <tfoot></tfoot>
                  ...
                  <div class="bethapa-table-header">
                   BRANDS DETAILS <button v-if="infoaddproductbrand > 0" type="button" class="add-newm" @click="newModalBrand" >Add New </button>
                      </div>
              <table class="table table-bordered table-striped">
                  <thead>
                    <tr>
                  ...
                  <tbody>
                    ...
                    <td>{{mydataObjectbrand.id}}</td>
                     ...
                     <td> {{ (mydataObjectbrand.brandname)}}</td>
                  
                    
                   <td> {{ (mydataObjectbrand.description)}}</td>
        ...
        <div class="modal-dialog modal-ml">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title" v-show="!editmode">NEW UNIT OF MEASURE</h4>
...
<form @submit.prevent="editmode ? updateUnit():createNewrecordUnitm()">
 ...
 <div class="form-group">
                <div class ="bethapa-table-header">UNIT DETAILS</div>
                    <label>Unit Name</label>
                     <input v-model="form.unitname" type="text" name="unitname"
                     class="form-control form-control-sm" :class="{ 'is-invalid': form.errors.has('unitname') }">
        ...
        class="form-control form-control-sm" :class="{ 'is-invalid': form.errors.has('shotcode') }"></textarea>
...
<form @submit.prevent="editmode ? updateBrand():createNewrecordbrand()">
 ...
 <div class="modal fade" id="addNewproductcategory">
        <div class="modal-dialog modal-ml">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title" v-show="!editmode">NEW PRODUCT CATEGORY</h4>
                   <h4 class="modal-title" v-show="editmode">Update Record</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
...
<form @submit.prevent="editmode ? updateRecordproductcategory():createNewrecordproductcat()">
 ...
 <div class="form-group">
                <div class ="bethapa-table-header">CATEGORY DETAILS</div>
                    <label>Category Name</label>
                     <input v-model="form.catname" type="text" name="catname"
                     class="form-control form-control-sm" :class="{ 'is-invalid': form.errors.has('catname') }">
 ...
 <div class="modal fade" id="addNew">
        <div class="modal-dialog modal-ml">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title" v-show="!editmode">NEW PRODUCT DETAILS</h4>
                   <h4 class="modal-title" v-show="editmode">Update Record</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
...
<form @submit.prevent="editmode ? updateRecord():createNewrecord()">
 ...
 <div class="form-group">
                <div class ="bethapa-table-header">Product Details</div>
                  ...
                  <div class="form-group">
                  <label>Brand Name</label>
                    <select name ="brand" v-model="form.brand" id ="brand" v-on:change="myClickEvent" class="form-control" :class="{'is-invalid': form.errors.has('brand')}">
                    <option value=" ">  </option>
       ...
       <div class="form-group">
                  <label>Product Category</label>
                    <select name ="category" v-model="form.category" id ="category" v-on:change="myClickEvent" class="form-control" :class="{'is-invalid': form.errors.has('category')}">
                    <option value=" ">  </option>
                    <option v-for='data in categorieslist' v-bind:value='data.id'>{{ data.id }} - {{ data.catname }}</option>
                  ...
                  <label>Unit of Measure</label>
                    <select name ="unitmeasure" v-model="form.unitmeasure" id ="unitmeasure" v-on:change="myClickEvent" class="form-control" :class="{'is-invalid': form.errors.has('unitmeasure')}">
                    <option value=" ">  </option>
                    <option v-for='data in unitslist' v-bind:value='data.id'>{{ data.id }} - {{ data.unitname }} ({{ data.shotcode }})</option>

                    </select>
                   

                                <has-error :form="form" field="unitmeasure"></has-error>
                               
                                </div>
  
   <div class ="bethapa-table-header">Stock Details</div>
 <div class="form-group">
               
                    <label>Re-Stock Quantity</label>
                     <input v-model="form.rol" type="number" name="rol"
                     class="form-control form-control-sm" :class="{ 'is-invalid': form.errors.has('rol') }">
...
// llkk
  updateBrand(){
    this.$Progress.start();
            ...
            ///console.log('Edidint data');
/// calling the function to update the data
this.form.put('api/productbrands/'+this.form.id)
  .then(()=> {
    // on success
 ...
 this.$Progress.fail();
    ...
    this.$Progress.start();
            ...
            ///console.log('Edidint data');
/// calling the function to update the data
this.form.put('api/productcategories/'+this.form.id)
  .then(()=> {
    // on success
              ...
              $('#addNewproductcategory').modal('show');
                                      ...
                                      deleteRecordproductcategory(id){
                                        ...
                                        confirmButtonText: 'Yes, delete it!'
                                          ...
                                          if(result.value){
                                                                        this.form.delete('api/productcategories/'+id).then(()=>{
...
// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  confirmButtonText: 'Yes, delete it!'
    ...
    if(result.value){
                                  this.form.delete('api/companyproducts/'+id).then(()=>{
...
// /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                 ...
                 axios.get("api/getAddnewproduct").then(({ data }) => (this.info = data));
                  axios.get("api/getviewproduct").then(({ data }) => (this.infoviewrecord = data));
                   ...
                   axios.get("api/geteditproduct").then(({ data }) => (this.infoedit = data));
                    ...
                    /// product categories
                     axios.get("api/getAddnewproductcategory").then(({ data }) => (this.infoaddnewcategory = data));
                    axios.get("api/getviewproductcategory").then(({ data }) => (this.infoviewrecordcategory = data));
                    axios.get("api/geteditproductcategory").then(({ data }) => (this.infoeditcategory = data));
                    axios.get("api/getdeleteproductcategory").then(({ data }) => (this.infodeletecategory = data));
            ...
            loadDatarecords(){
                   axios.get("api/companyproductscomponentaccess").then(({ data }) => (this.allowedtoaccesscomponent = data));
                    ...
                    axios.get("api/productcategoriescomponentaccess").then(({ data }) => (this.allowedtoaccesscategoriescomponent = data));
               ...
               /// Product components Access
                    ...
                    axios.get("api/companyproducts").then(({ data }) => (this.mydataObject = data));
                    ...
                    // axios.get("api/getBranches").then(({ data }) => (this.brancheslist = data));
                      ...
                      axios.get("api/getsuppliers").then(({ data }) => (this.supplierslist = data));
   ...
   loadDatarecordsCategories(){
                   axios.get("api/companyproductscomponentaccess").then(({ data }) => (this.allowedtoaccesscomponent = data));
                    ...
                    axios.get("api/productcategories").then(({ data }) => (this.mydataObjectProductcategories = data));
...
// /////////////// closure of brand
  ...
  this.$Progress.start();
this.form.post('api/productcategories')
.then(()=>{
...
//this.form.post('api/branchtobalance');
      ...
      //   this.loadDatarecordsCategories();
      //                     //      axios.get("api/getbranchnamebalancing").then(({ data }) => (this.shopbalancngname = data));
      //                           Fire.$on('AfterAction', () =>{
      //   this.loadDatarecordsCategories();
      // });

      //  this.loadDatarecordsProductbrands();
      //                     //      axios.get("api/getbranchnamebalancing").then(({ data }) => (this.shopbalancngname = data));
      //                           Fire.$on('AfterAction', () =>{
      //   this.loadDatarecordsProductbrands();
      // });
      //  this.loadDatarecordsProductunits();
      //                     //      axios.get("api/getbranchnamebalancing").then(({ data }) => (this.shopbalancngname = data));
      //                           Fire.$on('AfterAction', () =>{
      //   this.loadDatarecordsProductunits();
      // });
