            ...
            <div class="card card-primary card-tabs">
              <div class="card-header p-0 pt-1">
                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill" href="#custom-tabs-one-home" role="tab" aria-controls="custom-tabs-one-home" aria-selected="true">Sub-Menu  Settings</a>
                  </li>
                  <li class="nav-item">
  ...
  <label>SELECTED  ROLE  :    </label>       <label> </label>
        ...
        <div class="row">
          <div class="col-md-5">
            <div class="card card-primary collapsed-card">
              <div class="card-header">
                <h3 class="card-title">Main Menu Access</h3>
    ...
    <div class="card">
               ...
               <div class ="bethapa-table-header"> <tr v-for="rolenameinactionsss in rolenameinaction.data" :key="rolenameinaction.id">
                <td>{{rolenameinactionsss.name}}. </td></tr> AUTHORISED Sub - MENUS <button type="button" class="btn add-new btn-xs" @click="newModal" >Add Sub-Menus </button></div>
              <!-- /.card-header -->
...
<div  v-if="pendingtransfer < 1" >
 ...
 <div class="modal fade" id="addNew">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title" v-show="!editmode">Activate</h4>
...
<form @submit.prevent="SaveRecordbranch()">
                  ...
                  <label>Sub Menu</label>
                    ...
                    <option value=" ">  </option>
                    <option v-for='data in componentslist' v-bind:value='data.id'>{{ data.id }} - {{ data.name }}</option>
...
$('#addNew').modal('show');
  ...
  confirmButtonText: 'Yes, delete it!'
    ...
    if(result.value){
            ...
            loadDatarecords(){
              axios.get("api/subnmenuaccesscomponentaccess").then(({ data }) => (this.allowedtoaccesscomponent = data));
   axios.get("api/authorisedsubmenus").then(({ data }) => (this.mydataObject = data));
      ...
      axios.get("api/getSubmenues").then(({ data }) => (this.componentslist = data));
...
this.form.post('api/roletobalance');
 axios.get("api/authorisedmainmenus").then(({ data }) => (this.mydataObject = data));
