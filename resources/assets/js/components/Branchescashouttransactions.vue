...
<div>
     <div class="card" v-if="allowedtoaccesscomponent > 0 ">
              ...
              <div class="card-header">
                <h3 class="card-title"><b> Cash-OUT Transactions </b></h3>
...
<div  >
 ...
 <div class="modal fade" id="addNew">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title" v-show="!editmode">SHOP CREDIT</h4>
                   <h4 class="modal-title" v-show="editmode">Update Record</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
...
// Our method to GET results from a Laravel endpoint
      getResults(page = 1) {
                        axios.get('api/cashoutfromoffice?page=' + page)
                          .then(response => {
...
this.form.put('api/cashoutfromoffice/'+this.form.id)
  .then(()=> {
    // on success
   $('#addNew').modal('hide');
    swal.fire(
...
$('#addNew').modal('show');
  ...
  confirmButtonText: 'Confirm'
    ...
    if(result.value){
            ...
            loadDatarecords(){
                axios.get("api/shopcasouttransactionscomponentaccess").then(({ data }) => (this.allowedtoaccesscomponent = data));
        axios.get("api/shopcashoutdetails").then(({ data }) => (this.mydataObject = data));
   ...
   axios.get("api/getbranchopenningbalancefortoday").then(({ data }) => (this.shopopenningbalance = data));
     ...
     ////
                   ...
                   axios.get("api/getAddnewshopcollection").then(({ data }) => (this.info = data));
                   axios.get("api/getviewshopcollectionrecord").then(({ data }) => (this.infoviewrecord = data));
                    axios.get("api/geteditshopcollection").then(({ data }) => (this.infoedit = data));
                    axios.get("api/getdeleteshopcollection").then(({ data }) => (this.infodelete = data));
                   ///
            },
             checkAccess(){
  ...
  this.$Progress.start();
this.form.post('api/finalcashout')
.then(()=>{
