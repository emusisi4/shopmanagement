...
<div>
    <div class="card" v-if="allowedtoaccesscomponent > 0 ">
              <div class="card-header">
                <h3 class="card-title"><b>BRANCH EXPENSES</b></h3>
 ...
 <label for="exampleInputEmail1">End Date</label>
      ...
      <has-error :form="form" field="enddate"></has-error>
        ...
        <label>Branch</label>
<select name ="branchmade" v-model="form.branchmade" id ="branchmade"
 v-on:click="loadDatarecords()" class="form-control-sm" :class="{'is-invalid': form.errors.has('branchmade')}">
...
<div></div>
                ...
                <table class="table table-bordered table-striped">
                 ...
                 <th>    
                    ...
                    <span style="font-size:1.5em;" center > SSP {{ formatPrice(dailyexpensestotal) }}  </span></span>    </th>  
  ...
  confirmButtonText: 'Yes, delete it!'
    ...
    if(result.value){
           ...
           checkAccess(){
            ...
            loadDatarecords(){
                axios.get("api/expensereportbybranchcomponentaccess").then(({ data }) => (this.allowedtoaccesscomponent = data));
