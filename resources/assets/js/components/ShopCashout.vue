...
<div>
      <div class="card" v-if="allowedtoaccesscomponent > 0 ">
              ...
              <div class="card-header">
                <h3 class="card-title"><b> SHOP CASHIN</b></h3>

                <div class="card-tools">
                     <div v-if="branchbalancedforthisdate < 1 "  >
                   
                 </div>
                 <button type="button" class="btn btn-success btn-xs" @click="newModal" >Collect </button>
...
$('#addNew').modal('show');
  ...
  confirmButtonText: 'Confirm'
    ...
    if(result.value){
            ...
            loadDatarecords(){
               axios.get("api/admincashcollectioncomponentaccess").then(({ data }) => (this.allowedtoaccesscomponent = data));
