              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <td>{{mydataObjectinfo.branchno}}</td>
                     <td>{{mydataObjectinfo.branchname}}</td>
                     <td>{{mydataObjectinfo.location}}</td>
                        <td>{{mydataObjectinfo.contact}}</td>
                             <td>     <span class="badge badge-success centered">6</span></td>
...
<form @submit.prevent="editmode ? updateRecord():createNewrecord()">
        ...
        class="form-control form-control-sm" :class="{ 'is-invalid': form.errors.has('branchname') }">
...
$('#addNew').modal('show');
  ...
  confirmButtonText: 'Yes, delete it!'
    ...
    if(result.value){
            ...
            loadDatarecords(){
               axios.get("api/branchescomponentaccess").then(({ data }) => (this.allowedtoaccesscomponent = data));
