...
<div class="bethapa-component-header" >SYSTEM SETTINGS </div>
            ...
            <div class="card card-primary card-outline card-tabs">
              <div class="card-header p-0 pt-1 border-bottom-0">
                <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                  ...
                  <li class="nav-item" v-if="allowedtoaccessrolescomponent > 0 ">
                    <a class="nav-link" id="custom-tabs-three-profile-tab" data-toggle="pill" href="#custom-tabs-three-profile" role="tab" @click="loadDatarecordsMainmenus()" aria-controls="custom-tabs-three-profile" aria-selected="false">Main Category</a>
                  </li> 
            
                   <li class="nav-item" v-if="allowedtoaccessproductunitscomponent > 0 ">
                   <a class="nav-link" id="custom-tabs-three-messages-tab" data-toggle="pill" href="#custom-tabs-three-messages" role="tab"  @click="loadDatarecordsProductunits()" aria-controls="custom-tabs-three-messages" aria-selected="false">Main-Menus</a>
                   </li>
                  <li class="nav-item" v-if="allowedtoaccessbrandscomponent > 0 ">
                    <a class="nav-link" id="custom-tabs-three-settings-tab" data-toggle="pill" href="#custom-tabs-three-settings" role="tab" @click="loadDatarecordsProductbrands()" aria-controls="custom-tabs-three-settings" aria-selected="false">Sub-Menus</a>
                  </li>
              ...
              <div class="card-body">
                <div class="tab-content" id="custom-tabs-three-tabContent">
                  <div class="tab-pane fade active show" id="custom-tabs-three-home" role="tabpanel" aria-labelledby="custom-tabs-three-home-tab">
                     ...
                     Users  Details <button v-if="info > 0" type="button" class="add-newm" @click="newModal" >Add New </button>
                     </div>
              ...
              <table class="table table-bordered table-striped">
                 ...
                 <tfoot></tfoot>
                  ...
                  <div class="tab-pane fade" id="custom-tabs-three-profile" role="tabpanel" aria-labelledby="custom-tabs-three-profile-tab">
                    <div class="bethapa-table-header">
                   Main Menu Details <button v-if="infoaddnewmainmenu > 0" type="button" class="add-newm" @click="newModalmainmenu" >Add New </button>
                      </div>
              <table class="table table-bordered table-striped">
                  <thead>
                    <tr>
                  ...
                  <tbody>
                    <tr>
                        <tr v-for="mydataObjectinfo in mainmenuDatainfo.data" :key="mydataObjectinfo.id">
                    ...
                    <td>{{mydataObjectinfo.id}}</td>
                     ...
                     <td>{{mydataObjectinfo.iconclass}}</td>
                        <td>{{mydataObjectinfo.dorder}}</td>
                          ...
                          <td>     
                            <a href="#">
                               <button type="button"  v-if="infoeditmainmenu > 0"  class="btn  bg-gradient-secondary btn-xs fas fa-edit"  @click="editModalmainmenu(mainmenuDatainfo)">Edit</button>
                              </a>
                               <a href="#">
                                     <button type="button"  v-if="infodeletemainmenu > 0" class="btn  bg-gradient-danger btn-xs fas fa-trash-alt" @click="deleteRecordmainmenu(mainmenuDatainfo.id)"> Del</button></a>
                      </td>
                    </tr>
                ...
                <div class="bethapa-table-header">
                   ...
                   UNIT OF MEASUREMENTS DETAILS <button v-if="infoaddnewunitmeasure > 0" type="button" class="add-newm" @click="newModalf" >Add New </button>
                      </div>
              <table class="table table-bordered table-striped">
                  <thead>
                    <tr>
                  ...
                  <tbody>
                   ...
                   <td> {{ (mydataObjectunit.shotcode)}}</td>
                     ...
                     <button type="button"  v-if="infoeditunitmeasure > 0"   class="btn  bg-gradient-secondary btn-xs fas fa-edit"   @click="jj(mydataObjectunit)">   </button>
                      <button type="button"  v-if="infodeleteRole > 0" class="btn  bg-gradient-danger btn-xs fas fa-trash-alt"  @click="bbb(mydataObjectunit.id)">  </button>
                 <button type="button" v-if="infoviewrecordunitmeasure > 0"   class="btn  bg-gradient-info btn-xs fas fa-eye"   @click="jj(mydataObjectunit)">   </button>
                      </td>
                    </tr>
...
<form @submit.prevent="editmode ? updateRecordmainmenu():createNewrecordmainmenu()">
 ...
 <div class="modal fade" id="addNewrole">
        <div class="modal-dialog modal-ml">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title" v-show="!editmode">New Record</h4>
                   <h4 class="modal-title" v-show="editmode">Update Record</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
...
<form @submit.prevent="editmode ? updateRole():createNewrecordrole()">
 ...
 <div class="form-group">
                <div class ="bethapa-table-header">Role Details</div>
...
$('#addNewproductcategory').modal('show');
                 ...
                 editModalproductcategory(datacollectionRoles){
                this.editmode = true;
                this.form.clear();
                this.form.reset();
              this.form.fill(datacollectionRoles);
              $('#addNewproductcategory').modal('show');
                          },
...
// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
     editModalmainmenu(mainmenuDatainfo){
                this.editmode = true;
                 this.form.clear();
        this.form.reset();
        this.form.fill(mainmenuDatainfo);
...
// /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                 ...
                 axios.get("api/getAddnewproduct").then(({ data }) => (this.info = data));
                  axios.get("api/getviewproduct").then(({ data }) => (this.infoviewrecord = data));
                   ...
                   axios.get("api/geteditproduct").then(({ data }) => (this.infoedit = data));
                    ...
                    /// product categories
                     axios.get("api/getAddnewproductcategory").then(({ data }) => (this.infoaddnewrole = data));
                    axios.get("api/getviewproductcategory").then(({ data }) => (this.infoviewrecordrole = data));
                    axios.get("api/geteditproductcategory").then(({ data }) => (this.infoeditrole = data));
                    axios.get("api/getdeleteproductcategory").then(({ data }) => (this.infodeleterole = data));
                    ...
                    axios.get("api/getdeleteproductunitmeasure").then(({ data }) => (this.infodeleteRole = data));
            ...
            loadDatarecords(){
                   axios.get("api/settingscomponentaccess").then(({ data }) => (this.allowedtoaccesscomponent = data));
                    axios.get("api/productbrandscomponentaccess").then(({ data }) => (this.allowedtoaccessbrandscomponent = data));
                    axios.get("api/rolescomponentaccess").then(({ data }) => (this.allowedtoaccessrolescomponent = data));
     ...
     loadDatarecordsMainmenus(){
                   axios.get("api/companyproductscomponentaccess").then(({ data }) => (this.allowedtoaccesscomponent = data));
                    axios.get("api/productbrandscomponentaccess").then(({ data }) => (this.allowedtoaccessbrandscomponent = data));
                    axios.get("api/rolescomponentaccess").then(({ data }) => (this.allowedtoaccessrolescomponent = data));
                    axios.get("api/productunitscomponentaccess").then(({ data }) => (this.allowedtoaccessproductunitscomponent = data));
                             // /// Product units of measure
                      axios.get("api/getAddnewmainmenu").then(({ data }) => (this.infoaddnewmainmenu = data));
                   // axios.get("api/getviewproductunitmeasure").then(({ data }) => (this.infoviewrecordunitmeasure= data));
                    axios.get("api/geteditmainmenu").then(({ data }) => (this.infoeditmainmenu= data));
                    axios.get("api/getdeletemainmenu").then(({ data }) => (this.infodeletemainmenu = data));

                
                     axios.get("api/mainmenucomponents").then(({ data }) => (this.mainmenuDatainfo = data));
             ...
             loadDatarecordsProductunits(){
                   axios.get("api/companyproductscomponentaccess").then(({ data }) => (this.allowedtoaccesscomponent = data));
                    ...
                    axios.get("api/getdeleteproductunitmeasure").then(({ data }) => (this.infodeleteRole = data));
                     ...
                     axios.get("api/roles").then(({ data }) => (this.mydataObjectProductunitsofmeasurekdk = data));
...
Fire.$emit('AfterAction');
axios.get("api/user").then(({ data }) => (this.theuserscollectData = data));
