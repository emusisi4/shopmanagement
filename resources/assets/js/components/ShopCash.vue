...
<div>
        ...
        <div class="card" v-if="allowedtoaccesscomponent > 0 ">
              ...
              <div class="card-header">
                <h3 class="card-title"><b> Shop Cash-Out Details </b></h3>
                ...
                <div class="card-tools">
                    ...
                    <button type="button" class="btn btn-primary btn-xs" @click="newModal" >Send Cash </button>
...
$('#addNew').modal('show');
  ...
  confirmButtonText: 'Confirm'
    ...
    if(result.value){
            ...
            loadDatarecords(){
              axios.get("api/admincashissuecomponentaccess").then(({ data }) => (this.allowedtoaccesscomponent = data));
        axios.get("api/cashoutfromoffice").then(({ data }) => (this.mydataObject = data));
