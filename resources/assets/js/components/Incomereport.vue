...
<div>
       <div class="card" v-if="allowedtoaccesscomponent > 0 ">
              <div class="card-header">
                <h3 class="card-title"><b>Income Report</b></h3>
     ...
     <div class="col container-fluid dblock container-fluid front-sec ml-0 px-0">    
                ...
                <div class="perf-section"> 
                 ...
                 <tfoot>   
                    ...
                    <span style="font-size:1.0em;" center > TOTAL COLLECTIONS </span></span></th>
                 <th>    
                    <span class="cell" style="color:maroon ;">  
   
                    <span style="font-size:1.0em;" center > SSP {{ formatPrice(rangetotalcollection) }}  </span></span>    </th>  
                     <th colspan='5'>  </th>    </tfoot>
                                   </table>
                  ...
                  <tbody>
                    <tr>
                       <tr v-for="mycreditsinfo in mycredits.data" :key="mycreditsinfo.id">
                           ...
                           <td>  {{((mycreditsinfo.transferdate))}}</td>
                              <td>   <template v-if="mycreditsinfo.branch_name">	{{mycreditsinfo.branch_name.branchname}}</template></td>
                                  <td>Ssp {{formatPrice((mycreditsinfo.amount))}} </td>
                 <td> </td>
                  <td> </td>
                            <td> </td>
                            <td> </td>
                            
                                    <td> {{((mycreditsinfo.description))}} </td>
                    </tr>
                 ...
                 <tfoot>   
                    ...
                    <span style="font-size:1.0em;" center > TOTAL CREDITS </span></span></th>
                 <th>    
                    <span class="cell" style="color:maroon ;">  
   
                    <span style="font-size:1.0em;" center > SSP {{ formatPrice(rangetotalcredits) }}  </span></span>    </th>  
                     <th colspan='5'>  </th>    </tfoot>
                                   </table>
                            </div>
  <div class="performers">
                                <div class=""> INCOMES SUMMARY </div>
                                    <div class="bethapa-table-header"></div>
                                <table  style="width:98%">
                  <thead>
                    <tr>
                   
                      <th colspan='5'> From 2020-11-01 To 2020-11-30 (Shrikat Branch) </th>
                       <th colspan='1'>  </th>
                      <th colspan='1'>  </th>
                      <th colspan='4'></th>
...
$('#addNew').modal('show');
  ...
  confirmButtonText: 'Yes, delete it!'
   ...
   axios.get("api/incomereportcomponentaccess").then(({ data }) => (this.allowedtoaccesscomponent = data));
