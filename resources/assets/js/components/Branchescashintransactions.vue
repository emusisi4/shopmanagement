...
<div>
    <div class="card" v-if="allowedtoaccesscomponent > 0 ">
              ...
              <div class="card-header">
                <h3 class="card-title"><b> SHOP CASH - IN Transactions</b></h3>
                ...
                <table class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <tr>
                       ...
                       <td>{{(mydataObjectinfo.transferdate)}}</td>
                       <td>   <template v-if="mydataObjectinfo.branch_name">	{{mydataObjectinfo.branch_name.branchname}}</template></td>
                       <td> <template v-if="mydataObjectinfo.branch_namefrom">	{{mydataObjectinfo.branch_namefrom.branchname}}</template></td>
                       <td>Ssp {{formatPrice(mydataObjectinfo.amount)}}</td>
                       <td> <template v-if="mydataObjectinfo.cerated_userdetails">	{{mydataObjectinfo.cerated_userdetails.name}}</template></td>
                       <td>{{(mydataObjectinfo.comptime)}}</td>
                       <td> <template v-if="mydataObjectinfo.approved_userdetails">	{{mydataObjectinfo.approved_userdetails.name}}</template></td>
                       <td> <template v-if="mydataObjectinfo.status_name">	{{mydataObjectinfo.status_name.name}}</template></td>
                       <td>
                       <button v-show="mydataObjectinfo.status < 1" type="button"   class="btn  bg-gradient-secondary btn-xs"  @click="confirmCashintransfer(mydataObjectinfo.id)"> Confirm  </button>
                       <button v-show="mydataObjectinfo.status === 1" type="button"   class="btn  bg-gradient-success btn-xs"  > Confirmed  </button>
...
<div class="modal fade" id="confirmMoalshow">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title" v-show="!editmode">Confirm CashIn</h4>
...
<form @submit.prevent="SaveRecordbranch()">
  ...
  <label>Openning     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;     : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                  ...
                  <span class="cell" style="color:maroon ;">  
                   ...
                   <span style="font-size:1.5em;" center > Ssp {{ formatPrice(shopopenningbalance) }}   </span></span> 
                  ...
                  <span class="cell" style="color:maroon ;">  
                   ...
                   <span style="font-size:1.5em;" center > Ssp {{ formatPrice(totalcashin) }}   </span></span> 
                  ...
                  <span class="cell" style="color:maroon ;">  
                   ...
                   <span style="font-size:1.5em;" center > Ssp {{ formatPrice(totalexpenses) }}   </span></span> 
                  ...
                  <span class="cell" style="color:maroon ;">  
                   ...
                   <span style="font-size:1.5em;" center > Ssp {{ formatPrice(totalcashout) }}   </span></span> 
                  ...
                  <span class="cell" style="color:maroon ;">  
                   ...
                   <span style="font-size:1.5em;" center > Ssp {{ formatPrice(totalpayout) }}   </span></span> 
                  ...
                  <span class="cell" style="color:maroon ;">  
                   ...
                   <span style="font-size:1.5em;" center > Ssp {{ formatPrice(shopopenningbalance+totalcashin-totalcashout-totalexpenses-totalpayout) }}   </span></span> 
...
<div class ="bethapa-table-header">COLLECTION</div>
                  <div class="form-group">
                  <label>Branch</label>
                    <select name ="branchnametobalance" v-model="form.branchnametobalance" id ="branchnametobalance" v-on:change="myClickEvent" class="form-control" :class="{'is-invalid': form.errors.has('branchnametobalance')}">
                    <option value=" ">  </option>
...
<div  >
  ...
  <button v-show="!editmode" type="submit" class="btn btn-primary btn-sm">Commit</button>
 ...
 <div class="modal fade" id="addNew">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title" v-show="!editmode">CASH COLLECTION</h4>
                   <h4 class="modal-title" v-show="editmode">Update Record</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
...
<div  >
 ...
 <div class="modal fade" id="ceditbranch">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title" v-show="!editmode">CREDIT BRANCH</h4>
                   <h4 class="modal-title" v-show="editmode">Update Record</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
...
<form @submit.prevent="SaveRecordbranch()">
                 ...
                 <div class="form-group">
                  ...
                  <span class="cell" style="color:maroon ;">  
                   ...
                   <span style="font-size:1.5em;" center > Ssp {{ formatPrice(shopopenningbalance) }}  </span></span> 
                     ...
                     class="form-control form-control-sm" :class="{ 'is-invalid': form.errors.has('datedone') }">
  ...
  <hr>    
        ...
        class="form-control form-control-sm" :class="{ 'is-invalid': form.errors.has('scsales') }">
...
// Our method to GET results from a Laravel endpoint
      getResults(page = 1) {
                        axios.get('api/cashindetails?page=' + page)
                          .then(response => {
...
this.form.put('api/cashindetails/'+this.form.id)
  .then(()=> {
    // on success
   $('#addNew').modal('hide');
    swal.fire(
 ...
 this.$Progress.fail();
        ...
        this.form.fill(mydataObject);
         $('#addNew').modal('show');
              ...
              confirmModal(mydataObject){
             //   this.editmode = true;
                 this.form.clear();
     //   this.form.reset();
        this.form.fill(mydataObject);
         $('#confirmMoalshow').modal('show');
            },
...
$('#addNew').modal('show');
  ...
  confirmButtonText: 'Yes, delete it!'
   ...
   confirmCashintransfer(id){
                swal.fire({
  title: 'Approve Cashin',
  text: "You are about to complete this transfer",
  icon: 'warning',
  showCancelButton: true,
  confirmButtonColor: '#3085d6',
  cancelButtonColor: '#d33',
  confirmButtonText: 'Confirm'
    ...
    if(result.value){
            ...
            loadDatarecords(){
         axios.get("api/shopcasintransactionscomponentaccess").then(({ data }) => (this.allowedtoaccesscomponent = data));
    
        axios.get("api/cashindetails").then(({ data }) => (this.mydataObject = data));
...
//    axios.get("api/getdaycashoutbranch").then(({ data }) => (this.totalcashout = data));   getdaycashoutbranch  getdayexpensesbranch  getdaypayoutbranch
...
//    axios.get("api/getdaypayoutbranch").then(({ data }) => (this.totalpayout = data));
   axios.get("api/getbranchopenningbalancefortoday").then(({ data }) => (this.shopopenningbalance = data));
     ...
     axios.get("api/gettodaycashin").then(({ data }) => (this.totalcashin = data));
            },
            createNewrecord(){
