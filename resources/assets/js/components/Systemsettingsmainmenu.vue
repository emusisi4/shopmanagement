            ...
            <div class="card card-primary card-tabs">
              <div class="card-header p-0 pt-1">
                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill" href="#custom-tabs-one-home" role="tab" aria-controls="custom-tabs-one-home" aria-selected="true">Main Menu  Settings</a>
                  </li>
                  <li class="nav-item">
  ...
  <label>SELECTED  ROLE  :    </label>       <label> </label>
    ...
    <div class="card">
               ...
               <div class ="bethapa-table-header"> <tr v-for="rolenameinactionsss in rolenameinaction.data" :key="rolenameinaction.id">
                <td>{{rolenameinactionsss.name}}. </td></tr> AUTHORISED MAIN - MENUS <button type="button" class="btn add-new btn-xs" @click="newModal" >Add Menus </button></div>
              <!-- /.card-header -->
...
<div  v-if="pendingtransfer < 1" >
 ...
 <div class="modal fade" id="addNew">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title" v-show="!editmode">Activate Main Menu</h4>
...
$('#addNew').modal('show');
  ...
  confirmButtonText: 'Yes, delete it!'
    ...
    if(result.value){
            ...
            loadDatarecords(){
               axios.get("api/mainmenuaccesscomponentaccess").then(({ data }) => (this.allowedtoaccesscomponent = data));
   axios.get("api/authorisedmainmenus").then(({ data }) => (this.mydataObject = data));
      ...
      axios.get("api/getMainmenues").then(({ data }) => (this.componentslist = data));
