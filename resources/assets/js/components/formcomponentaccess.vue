            ...
            <div class="card card-primary card-tabs">
              <div class="card-header p-0 pt-1">
                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill" href="#custom-tabs-one-home" role="tab" aria-controls="custom-tabs-one-home" aria-selected="true">Settings</a>
                  </li>
                  <li class="nav-item">
  ...
  <label>Component</label>
        ...
        <div class="row">
          <div class="col-md-5">
            <div class="card card-primary collapsed-card">
              <div class="card-header">
                <h3 class="card-title">Form Feetures Access</h3>
    ...
    <div class="card">
               ...
               <div class ="bethapa-table-header"> <tr v-for="rolenameinactionsss in rolenameinaction.data" :key="rolenameinaction.id">
                <td>{{rolenameinactionsss.name}}. </td></tr> AUTHORISED FORM FEATURES <button type="button" class="btn add-new btn-xs" @click="newModal" >Add Access </button></div>
              <!-- /.card-header -->
              <div class="card-body p-0">
                ...
                <td>{{mydataObjectinfo.id}}. </td>
                       <td>{{mydataObjectinfo.component}}</td>
                       <td>{{mydataObjectinfo.formcomponent}}</td>
                     <td>
...
<label>Form Component Feature</label>
                   <select name ="formfeatures" v-model="form.formfeatures" id ="formfeatures"  class="form-control" :class="{'is-invalid': form.errors.has('formfeatures')}">
                    <option value=" ">  </option>
                    <option v-for='data in formfeatures' v-bind:value='data.sysname'>{{ data.sysname }} - {{ data.name }}</option>
...
$('#addNew').modal('show');
  ...
  confirmButtonText: 'Yes, delete it!'
    ...
    if(result.value){
            ...
            loadDatarecords(){
               axios.get("api/systemcomponentscomponentaccess").then(({ data }) => (this.allowedtoaccesscomponent = data));
   axios.get("api/authorisedformcomponents").then(({ data }) => (this.mydataObject = data));
   

axios.get("api/componentslist").then(({ data }) => (this.mydataObject = data));
...
this.form.post('api/roleandcomponentto');
 axios.get("api/authorisedformcomponents").then(({ data }) => (this.mydataObject = data));
  axios.get("api/authorisedmainmenus").then(({ data }) => (this.mydataObjectmainmenu = data));
 axios.get("api/getcomponentslistmissing").then(({ data }) => (this.componentslist = data));
...
this.form.post('api/roleaddformcomponent');

  axios.get("api/getcomponentslist").then(({ data }) => (this.componentslist = data));
}
