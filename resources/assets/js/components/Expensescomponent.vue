              ...
              <div class="card-header p-0 pt-1 border-bottom-0">
                <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                  ...
                  <a class="nav-link active" id="custom-tabs-three-home-tab" data-toggle="pill" href="#custom-tabs-three-home" role="tab"  @click="loadDatarecords()"
                   aria-cont rols="custom-tabs-three-home" aria-selected="true">Authorised Expenses</a>
                  </li>
...
<select name ="expensename" v-model="form.expensename" id ="expensename" v-on:click="loadDatarecords()" class="form-control" :class="{'is-invalid': form.errors.has('expensename')}">
<option value=" ">  </option>
       ...
       //   axios.get("api/getdaycashinbranch").then(({ data }) => (this.totaldayscashin = data));
        ...
        created() {
          ...
          Fire.$on('searching', () => { 
            ...
            axios.get('api/findgeneralExpense?q=' + query)
            .then((data) =>{
              this.mydataObject = data.data;
