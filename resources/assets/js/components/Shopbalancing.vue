...
<div>
  ...
  <div class="card"  v-if="allowedtoaccesscomponent > 0 ">
              <div class="card-header">
                <h3 class="card-title"><b> BRANCH BALANCING RECORD </b></h3>
                  ...
                  <tbody>
                    ...
                    <td>{{mydataObjectinfo.id}}</td>
                     <td>{{mydataObjectinfo.datedone}}</td>
                      <td>   <template v-if="mydataObjectinfo.userbalancing_branch">	{{mydataObjectinfo.userbalancing_branch.name}}</template></td>
                    
                       <td>    <template v-if="mydataObjectinfo.branchin_balance">	{{mydataObjectinfo.branchin_balance.branchname}}</template></td>
                         
                               <td>Ssp {{formatPrice(mydataObjectinfo.opbalance)}}</td>
                               <td>Ssp {{formatPrice(mydataObjectinfo.scsales)}}</td>
                       <td>Ssp {{formatPrice(mydataObjectinfo.scpayout)}}</td>
                       <td>Ssp {{formatPrice(mydataObjectinfo.vsales)}}</td>
                       <td>Ssp {{formatPrice(mydataObjectinfo.vcan)}}</td>
                       <td>Ssp {{formatPrice(mydataObjectinfo.vpay)}}</td>
                       
                        <td>Ssp {{formatPrice((mydataObjectinfo.vprof))}}</td>

                  
                     <td>Ssp {{formatPrice((mydataObjectinfo.cashin))}}</td>
                    <td>Ssp {{formatPrice((mydataObjectinfo.cashout))}}</td>
                       <td>Ssp {{((mydataObjectinfo.expenses))}}</td>
                     
                      <td>Ssp {{formatPrice((mydataObjectinfo.clcash))}}</td>
                          

                            <td>
                              <div v-if="((mydataObjectinfo.clcash)-(mydataObjectinfo.reportedcash)) > 0">
                                <span class="cell" style="color:maroon ;">  
   
                    <span style="font-size:1.0em;" center >  Ssp {{formatPrice((mydataObjectinfo.clcash)-(mydataObjectinfo.reportedcash))}} </span></span>
                              </div>
                               <div v-if="((mydataObjectinfo.clcash)-(mydataObjectinfo.reportedcash)) < 1">
...
<div  v-if="pendingtransfer < 1" >
 ...
 <div class="modal fade" id="addNew">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title" v-show="!editmode">NEW BALACING RECORD</h4>
...
<form @submit.prevent="SaveRecordbranch()">
  ...
  <hr>
                 ...
                 <div class="form-group">
                  ...
                  <span class="cell" style="color:maroon ;">  
                   ...
                   <label>CASH-IN     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;     : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                    ...
                    <span style="font-size:1.5em;" center > Ssp {{ formatPrice(totaldayscashin) }}  </span></span>
                     <hr>
                  </div>
                      <div class="form-group">
               ...
               <label>PAYOUT      &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;     : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                    ...
                    <span style="font-size:1.5em;" center > Ssp {{ (totalpayout) }}  </span></span>
                      <hr>
                  </div>
      ...
      <has-error :form="form" field="scsales"></has-error>
        ...
        class="form-control form-control-sm" :class="{ 'is-invalid': form.errors.has('sctkts') }">
      <has-error :form="form" field="sctkts"></has-error>
      
                  </div>
              

 <div class ="bethapa-table-header">Virtual</div>

 <div class="form-group">
                    <label>Sales</label>
                     <input v-model="form.vsales" type="text" name="vsales"
        class="form-control form-control-sm" :class="{ 'is-invalid': form.errors.has('vsales') }">
      <has-error :form="form" field="vsales"></has-error>
        ...
        class="form-control form-control-sm" :class="{ 'is-invalid': form.errors.has('vcan') }">
      <has-error :form="form" field="vcan"></has-error>
      
                  </div>
                   <div class="form-group">
                <label>Payout / Redeemed</label>
                     <input v-model="form.vpay" type="text" name="vpay"
        class="form-control form-control-sm" :class="{ 'is-invalid': form.errors.has('vpay') }">
      <has-error :form="form" field="vpay"></has-error>
      
                  </div>
               <div class="form-group">
                <label>Total Tickets Sold</label>
                     <input v-model="form.vtkts" type="text" name="vtkts"
        class="form-control form-control-sm" :class="{ 'is-invalid': form.errors.has('vtkts') }">
 ...
 <div class="form-group">
        ...
        class="form-control form-control-sm" :class="{ 'is-invalid': form.errors.has('reportedcash') }">
...
$('#addNew').modal('show');
  ...
  confirmButtonText: 'Yes, delete it!'
    ...
    if(result.value){
            ...
            loadDatarecords(){
                 axios.get("api/shopbalancingcomponentaccess").then(({ data }) => (this.allowedtoaccesscomponent = data));
                   axios.get("api/getAddnewbalancingrecord").then(({ data }) => (this.info = data));
                   axios.get("api/getviewbalancingrecord").then(({ data }) => (this.infoviewrecord = data));
   ...
   axios.get("api/currentbalancingrecords").then(({ data }) => (this.mydataObject = data));
