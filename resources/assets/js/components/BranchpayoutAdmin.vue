...
<div>
      <div class="card" v-if="allowedtoaccesscomponent > 0 ">
              ...
              <div class="card-header">
                <h3 class="card-title"><b>BRANCH PAYOUT  - Details</b></h3>

                <div class="card-tools">
                   
                    
                    <button type="button" class="btn btn-success btn-xs" @click="newModal" >Payout </button>
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-bordered table-striped">
                 ...
                 <td>{{mydataObjectinfo.receiptno}}</td>
                 <td>    <template v-if="mydataObjectinfo.expense_typeconnect">	{{mydataObjectinfo.expense_typeconnect.branchname}}</template></td>

                 <td>{{mydataObjectinfo.datemade}}</td>

                 <td>    <template v-if="mydataObjectinfo.expense_category">	{{mydataObjectinfo.expense_category.branchname}}</template></td>
                                              
                                                
                 <td>{{mydataObjectinfo.amount}}</td>
                 <td>{{mydataObjectinfo.datepaid}}</td>
                 <td>    <template v-if="mydataObjectinfo.paying_userdetails">	{{mydataObjectinfo.paying_userdetails.name}}</template></td>
                
                 <td>{{mydataObjectinfo.created_at}}</td>
                 <td>     
                   <button type="button"   class="btn  bg-gradient-info btn-xs fas fa-eye"  @click="editModal(mydataObjectinfo)"> View  </button>
...
<form @submit.prevent="editmode ? updateRecord():createNewrecord()">
        ...
        class="form-control form-control-sm" :class="{ 'is-invalid': form.errors.has('receiptno') }">
...
<div class="form-group">
                  <label>Branch Betted From</label>
...
<option value=""> Branch of that placed the Ticket </option>
...
<div class="form-group">
                  <label>Branch Paying the ticket </label>
<select name ="branchpayingtheticket" v-model="form.branchpayingtheticket" id ="branch" v-on:click="loadDatarecords()" class="form-control" :class="{'is-invalid': form.errors.has('branchpayingtheticket')}">
<option value=""> Branch Paying the ticket </option>
<option v-for='data in brancheslist' v-bind:value='data.branchno'>{{ data.branchno }} - {{ data.branchname }}</option>

</select>
            <has-error :form="form" field="branchpayingtheticket"></has-error>
            </div>
      ...
      <has-error :form="form" field="datemade"></has-error>
                   ...
                   <div class="form-group">
                    <label>Actual  Date of Payment</label>
                     <input v-model="form.datepaidd" type="date" name="datepaidd"
        class="form-control form-control-sm" :class="{ 'is-invalid': form.errors.has('datepaidd') }">
      <has-error :form="form" field="datepaidd"></has-error>
...
// Our method to GET results from a Laravel endpoint
      getResults(page = 1) {
                        axios.get('api/payouts?page=' + page)
                          .then(response => {
    ...
    this.$Progress.start();
      if(this.loggedinUser )
              {
                this.form.userid = this.loggedinUser.id;
              }
...
$('#addNew').modal('show');
  ...
  confirmButtonText: 'Yes, delete it!'
    ...
    if(result.value){
            ...
            loadDatarecords(){
                  axios.get("api/adminmakepayoutcomponentaccess").then(({ data }) => (this.allowedtoaccesscomponent = data));
                                 axios.get("api/payouts").then(({ data }) => (this.mydataObject = data));
                                    axios.get("api/dailypayoutstotalbranch").then(({ data }) => (this.branchpayoutdt = data));
                                ...
                                axios.get("api/getExpensecategories").then(({ data }) => (this.expensecategory = data));
                                       ...
                                       //// table footer values
                                //       axios.get("api/getShopdailydailypayout").then(({ data }) => (this.totaldailypayout = data));
